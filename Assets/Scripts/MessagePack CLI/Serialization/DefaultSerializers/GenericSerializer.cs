...
namespace MsgPack.Serialization.DefaultSerializers
{
	...
	internal static class GenericSerializer
	{
        ...
        static void aotdummy(){
            new DictionaryInstanceFactory<int, int>();
            new DictionaryInstanceFactory<string, int>();
            new DictionaryInstanceFactory<int, string>();
            new DictionaryInstanceFactory<int, long>();
            new ListInstanceFactory<int>();
            new ListInstanceFactory<long>();
        }
...
#if DEBUG && !XAMIOS && !XAMDROID && !UNITY_IPHONE && !UNITY_ANDROID && !UNITY
			Contract.Assert( instanceFactory != null );
